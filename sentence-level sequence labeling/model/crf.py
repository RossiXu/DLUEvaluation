...
class LinearCRF(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.b_idx = self.label2idx['B']
        self.i_idx = self.label2idx['I']
        self.o_idx = self.label2idx['O']
        self.e_idx = self.label2idx['E']
        self.s_idx = self.label2idx['S']
        ...
        init_transition[self.b_idx, self.b_idx] = -10000.0
        init_transition[self.i_idx, self.b_idx] = -10000.0
        init_transition[self.start_idx, self.i_idx] = -10000.0
        init_transition[self.e_idx, self.i_idx] = -10000.0
        init_transition[self.s_idx, self.i_idx] = -10000.0
        init_transition[self.b_idx, self.o_idx] = -10000.0
        init_transition[self.i_idx, self.o_idx] = -10000.0
        init_transition[self.o_idx, self.e_idx] = -10000.0
        init_transition[self.e_idx, self.e_idx] = -10000.0
        init_transition[self.s_idx, self.e_idx] = -10000.0
        init_transition[self.b_idx, self.s_idx] = -10000.0
        init_transition[self.i_idx, self.s_idx] = -10000.0
