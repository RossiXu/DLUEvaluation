...
def get_base_parser():
    ...
    setup_group.add_argument('--max_tgt_len', type=int, default=None,
                             help='maximum length')
    setup_group.add_argument('--max_entry', type=int, default=1500,
                             help='maximum sentence')
    ...
    misc_group.add_argument('--save_every', type=int, default=2000,
                            ...
                            this number of iterations')
    misc_group.add_argument('--stop_early', type="bool", default=False,
                            help='stop if dev loss not decrease')
